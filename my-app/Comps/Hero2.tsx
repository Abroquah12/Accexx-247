...
const Hero2 = () => {
  return (
    <div className='bg-blue-200 rounded-2xl shadow-lg p-5 flex flex-col space-y-6 relative bottom-20 right-20 z-10 w-[1050px] h-[160px] mx-auto mt-10 overflow-hidden'>
